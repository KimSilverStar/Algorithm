...
/*
1. 아이디어
 - 1 ~ n 까지의 풍선을 Deque에 저장
 - Deque이 empty 할 때까지 반복
   1) 터뜨린 풍선의 값이 양수 k인 경우
     - (k-1)개의 풍선을 덱의 First에서 뽑아서 Last로 넣음
     - 이후, 1개의 풍선을 덱의 First에서 뽑아서 터뜨림
   2) 터뜨린 풍선의 값이 음수 -k인 경우
     - (k-1)개의 풍선을 덱의 Last에서 뽑아서 First로 넣음
     - 이후, 1개의 풍선을 덱의 Last에서 뽑아서 터뜨림
...
3. 시간 복잡도
 - while 문으로 Deque이 empty 할 때까지 반복: O(n)
...
/* 오답 노트: 메모리 초과
 ...
 - 단순히 덱의 앞/뒤에서 item을 삽입/삭제 하는 경우,
