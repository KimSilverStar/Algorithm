...
1. 아이디어
 ...
 - 다음을 ptr2가 마지막 원소를 가리킬 때까지 반복
   1) ptr2 를 오른쪽으로 한 칸씩 이동(ptr2++)하면서, 원소 등장 횟수 카운트
   2) k번 초과 등장하는 동일 원소가 존재하는 경우
     - 해당 k번 초과 등장한 동일 원소의 등장 횟수가 k번 이하가 될 때까지,
